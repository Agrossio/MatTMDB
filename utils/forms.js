...
function userFormListener(registerForm, userInput, emailInput, pass1Input, pass2Input, userSession) {
        ...
        if (userInput === null) {
            ...
            if (validatedForm) {
                ...
                try {
                    ...
                    let response = await fetchJson(`http://localhost:8080/mattmdb-1.0-SNAPSHOT/api/v1/users/${userSession.userId}`, 'PUT', body)
                    console.log(response);
                    alert(response.message);
